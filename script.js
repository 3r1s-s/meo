...
function loadLanguages() {
    ...
    <div class="settings">
        ...
        <div class="languages">
            ...
            <button class="language button" id="es_es" onclick="changeLanguage('es_es')"><span class="language-l">${es_es.language}</span><span class="language-r">Spanish</span></button>
