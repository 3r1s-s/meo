...
const mbw = {
  "language": "mybearworld lang", // Replace this with that the language is called in that language (ie: "Español" instead of "Spanish")
  "page_home": "why are people making prs adding languages now", // To update a language easier I suggest looking at the diff between en and the language you're editing (sorry I don't have a better solution)
  "page_start": "and those languages don't even make any sense",
  "page_explore": "like there's barely any need for them",
  "page_inbox": "it's like conlangs but pointless",
  "page_settings": "oh wait",
  "meo_username": "wait that doesn't make any sense",
  "meo_password": "also conlangs are pointless i guess",
  "meo_totp": "but uhhh who cares", // update
  "meo_messagebox": Math.random() < 1/25 ? "what's the point of all these // update comments anyways" : "couldn't you just look at commit diffs",
  "meo_goanywhere": "i love using json files",
  "meo_welcome": "wait no these are js files i'm dumb",
  "meo_hello": "oh look here's another // update", // update
  "meo_userson": "where is that \"Hello!\" thingy used anyways",
  "meo_members": "just looks funny",
  "meo_bridged": {
      "start": "oo we're in an object now fancy",
      "title": "we're leaving the object now"
  },
  "meo_typing": {
      "one": "yay another object! {user} finds this very exciting",
      "two": "{user1} and {user2} are finding this exciting too",
      "multiple": "{user3} agrees with {user1} and {user2} and finds this exciting",
      "many": "{count} people find this exciting..."
  },
  "title_chats": "ok goodbye object",
  "title_live": "well we're still in an object i guess",
  "settings_general": "goodbye nested objects at least",
  "settings_account": "// update is back", // update
  "settings_appearance": "so exciting",
  "settings_plugins": "is this another object i see?",
  "settings_languages": "looking forward to it! (hey if this got merged for some reason and you applied it for some reason this is where you get rid of this)",
  "settings_profile": "why did i add that",
  "general_sub": {
      "chat": "idk",
      "accessibility": "oh look we're in the object",
      "misc": "what's this for",
      "acc": "probably setting categories?",
      "blockedusers": "hmm",
      "blockedwords": "there's a lot of properties in here",
      "about": "i don't like this object",
      "credits": "i'm getting kinda claustrophobic in here",
      "contrib": "can we leave?",
      "privacy": ":(",
  },
  "general_list": {
      "title": {
          "homepage": "yay i'm out of the object!",
          "consolewarnings": "so happy now :)",
          "blockedmessages": "wait",
          "invtyping": "am i in a different object now?!",
          "imagewhitelist": "and it's nested even further!",
          "censorwords": "i didn't sign up for this!",
          "embeds": "ok well this is not too bad",
          "reducemotion": "i'm going to distract myself",
          "showpostbuttons": "what are the contents of these things i'm editing anyways",
          "underlinelinks": "\"always underline links\"?",
          "magnify": "interesting",
          "entersend": "link underlines don't really look good",
          "hideimages": "i guess that's why they're a setting",
          "notifications": "they're probably accessible though but uh",
          "widemode": "who needs that anways",
          "discord": "how many properties do i still need to edit",
          "compactmode": "why am i doing this",
          "ulist": "i'm on line 2789",
      },
      "desc": {
          "homepage": "more objects!",
          "consolewarnings": "these are descriptions",
          "blockedmessages": "which the key of this object helpfully abbreviated",
          "invtyping": "\"desc\"",
          "imagewhitelist": "that just sounds like...",
          "censorwords": "wait there's no table emoji?",
          "embeds": "interesting",
          "reducemotion": "there's so many useless emoji but no table?",
          "showpostbuttons": "i'll have to request an addition at the unicode consortium",
          "underlinelinks": "ugh that's gonna be boring",
          "magnify": "oh hey grandma mode is here",
          "entersend": "but like seriously why is there no table emoji",
          "hideimages": "there's a chair emoji",
          "notifications": "i think?",
          "widemode": "wait is there?",
          "discord": "i'll check",
          "compactmode": "🪑",
          "ulist": "there is",
      }
  ...
  "account_sub": {
      "password": "cool",
      "privacy": "hm",
      "mfa": "why is prettier complaining",
      "mfainfoenabled": "there aren't any errors in this file",
      "mfainfodisabled": "i'm not even gonna use prettier here",
      "mfainfoincompatible": "lol does it think meo is formatted at all",
      "devices": "maybe that's why it's complaining",
      "added": "it's noticing the fact that it's not formatted and crying",
      "recoverycode": "i don't like mfa did you know",
  },
  "appearance_sub": {
      "theme": "when i tried making this branch i couldn't find the file",
      "spthemes": "and as it turns out:",
      "acthemes": "it's actually kind of important to pull",
      "ogthemes": "`git pull` created like 3701709 files",
      "glthemes": "joshatticus ripoff real",
      "cstheme": "i don't know what to put here",
      "cscss": "<insert complaining about the js comment here>",
  },
  "plugins_sub": {
      "manage": "like how can one be so foolish as to not know that css uses hashtags for comments",
      "desc": "i could not believe my eyes when i first saw that",
      "link": "crazy that people can be like this!"
  },
  "languages_sub": {
      "title": "that just shows an utter lack of care for accuracy",
      "desc": "like smh",
      "link": "i can't believe it seriously",
      "other": "i am so angry i am going to put angry emoji 😡"
  },
  "inbox_sub": {
      "desc": "so yeah",
  },
  "live_sub": {
      "desc": "i forgot what i was saying"
  },
  "login_sub": {
      "title": "oh right css comments!",
      "desc": "like who DOESn'T know that css uses <!-- --> for comments",
      "oldpass": "it's so obvious",
      "newpass": "every child knows this",
      "agreement": "this is the first thing you learn in kindergarden",
  },
  "leave_sub": {
      "desc": "it was very rude for english speakers to steal this word from german",
      "end": "seriously",
  },
  "action": {
      "logout": "if you're gonna steal one at least do it incorrectly smh",
      "login": "like do it like \"handy\"",
      "signup": "where its meaning is cell phone",
      "search": "absolutely nothing to do with it in english",
      "mod": "but you know,",
      "creategc": "it's english so it's good",
      "leavegc": "this",
      "dmme": "sentence",
      "invite": "is",
      "gohome": "stretched",
      ...
      "changepw": "across",
      "addtotp": "multiple",
      "resetrecovery": "strings",
      "clearls": "so uhhh",
      "deleteacc": "what was i talking about again",
      "block": "oh right, i was wondering why there are so many prs adding languages",
      "blockuser": "why would anyone do that",
      "blockword": "i couldn't even imagine creating a language for meo",
      "run": "Run!! NOW!!",
      "close": "lol what's that string for",
      "back": "maybe it's eris telling me what i should do",
      "opennewtab": "for making this pr right now",
      "reply": "...",
      "mention": "hopefully not",
      "report": "uhhh",
      "delete": "right, css comments!!",
      "edit": "EVERYONE knows css uses semicolons for comments!",
      "share": "(like in autohotkey)",
      "comment": "oh look this string literally says comment!",
      "nick": "even meo's code agrees!",
      "create": "or something!",
      "reason": "whar why is there an audio folder",
      "sendreport": "does meo have audio?",
      "yes": "ok this string says yes now so probably yes",
      "confirm": "i love having strings talk to me",
      "update": "but what kind of audio",
      "go": "you can tell how often i use meo",
      "apply": "i did not know meo had this much text",
      "savetheme": "yay line 2900",
      "loadtheme": "ok i'm gonna open the audio folder now",
      "resetplugins": "purr.wav?",
      "favorite": "lol that makes me even more confused",
      "download": "why does meo need a sound of purring",
      "add": "maybe it's just confusingly named",
      "adduser": "i'll try playing it",
      "transfer": "...",
      "bug": "what",
      "datarequest": "why is that called purr",
      "discuss": "it's like bubbles or something",
      "ping": "Pong! 🎾",
      "moddel": "and also when does meo use that",
      "modpost": "i haven't heard it ever",
      "message": "probably because i don't use meo enough",
      "uploademoji": "oh well",
      "editemoji": "CSS COMMENTS!",
      "name": "how do you not know css uses \"\"\" for comments!",
      "remove": "so simple!",
  },
  "info": {
      "accexists": "why is this in title case",
      "invaliduser": "that just looks bad",
      "invalidpass": "i guess it's your choice",
      "invalidcreds": "i'm bored",
      "invalidotp": "oh look, an // update! haven't had those in a bit", // update
      "unknownmfa": "pretty c- wait, another // update?", // update
      "nopass": "another one?!", // update
      "nocode": "AAAAA I'M BEING FLUDDED BY // UPDATs", // update
      "authadd": "WHEN IT WILL IT STOP", // update
      "authrename": "i'm gonna hide",
      "authremove": "...",
      "accbanned": "...",
      "accdeleted": "...",
      "conflict": "...",
      "unknown": "...",
      "chatremoved": "...",
      "passupdate": "are we safe now?",
      "editingpost": "ok, good",
      "reportsent": "what?",
      "blockedip": "no i didn't just use this to get through a couple of strings",
      "searchany": "what are you taaalking about",
      "cleartokens": "i'd never do that",
      "clearls": "well i would",
      "signup": "but i didn't do it now",
      "tokenscleared": "anyways CSS COMMENTS!!!",
      "accscheduled": "everyone knows it's any character that isn't one of []+-<>., for comments!",
      "deletewarn": "so simple!",
      "changepwwarn": "but yeah i guess that wasn't known when that was written",
      "tryagain": "i hate the last word of the original message of that",
      "cleared": "i can never spell it correctly without thinking about it",
      "plugin": "immideatly?",
      "replieslimit": "it just looks right but it was wrong", // update
  },
  "reports": {
      "spam": "yay, an // update!",
      "harassment": "these report messages are very useless now",
      "language": "their implementation is so weird",
      "nsfw": "meower svelte (and all major clients) imply that the reason is one of these",
      "scam": "but no, it's just a string",
      "harm": "whoever implemented reports for msvelte just decided to use these",
      "illegal": "which is pretty interesting",
      "suicide": "hmmm",
      "age": "modals are coming up!",
      "other": "very interesting",
  },
  "modals": {
      "report": "these are one of he few that aren't just gonna be sequential",
      "blockword": "so most of these would have",
      "blockauser": "pretty much no context",
      "blockuser": "if you see them",
      "unblockuser": "unif you see them",
      "bgimage": "not actually much left!",
      "blockedip": "i should go through more folders and wonder what they are",
      "cleartokens": "ah yes the share folder",
      "changepass": "i'm assuming that's for the share post thingy?",
      "clearls": "but my vscode thing highlights it as a file for shared code i think",
      "deleteacc": "or for some server stuff",
      "share": "which is pretty fun",
      "plugin": "it's purple",
      "shortcuts": "and has cogs? i think?",
      "copyuser": "it's very small",
      "copygc": "the others make sense though",
  },
  "profile": {
      "quote": "fonts has a serif Aa",
      "persona": "very rude of it to assume that all fonts are serif",
      "color": "our favorite font whitney isn't serif",
      "avatar": "so yeah i don't like this extension after all",
      "pronouns": "time to uninstall it and to not use any icons",
      "update": "the other one is images",
  },
  "chats": { // update
      "owner": "which is just one of these mountain image thingies",
      "settings": "\"thingies\"",
      "members": "that's fancy",
      "addmember": "manifest.webmanifest has the json file icon",
      "emojis": "which is kinda strange tbh",
      "uploademoji": "other json files like .prettierrc",
      "chatsettings": "(obviously not in this repo though lol)",
      "leave": "get their own icon",
      "update": "but .webmanifest doesn't",
  },
  "inputs": { // update
      "onetimecode": "// updates on entire sections",
      "password": "fun",
  }
}
