...
const dlsn = {
    "reh": "English, US", // future reference for people adding languages disregard the reh
    "language": "delusion", // Replace this with that the language is called in that language (ie: "Español" instead of "Spanish")
    "page_home": "you talk here", // To update a language easier I suggest looking at the diff between en and the language you're editing (sorry I don't have a better solution)
    "page_start": "start (turn this off in settings)",
    "page_explore": "user search",
    "page_inbox": "mail",
    "page_settings": "settings",
    "meo_username": "user",
    "meo_password": "pswd",
    "meo_totp": "auth app/recovery code", // update
    "meo_messagebox": Math.random() < 1/25 ? "go on..." : "say something",
    "meo_goanywhere": "lets go to...",
    "meo_welcome": "hi welcome to hell",
    "meo_hello": "welcome back", // update
    "meo_userson": "users online",
    "meo_members": "members",
    "meo_bridged": {
        "start": "bad",
        "title": "(unless splasj) this loser used a different place to post this (bad)"
    },
    "meo_typing": {
        "one": "{user} is typing",
        "two": "{user1}, {user2} are typing",
        "multiple": "{user1}, {user2}, {user3} are typing",
        "many": "{count} people are typing"
    },
    "title_chats": "gcs",
    "title_live": "livechar",
    "settings_general": "genaral",
    "settings_account": "account", // update
    "settings_appearance": "themes",
    "settings_plugins": "plugins",
    "settings_languages": "langs",
    ...
    "general_list": {
        "title": {
            "homepage": "no more start page",
            "consolewarnings": "i know what im doing meo",
            "blockedmessages": "you dont like em? no more then",
            "invtyping": "lurk mode but worse",
            "imagewhitelist": "hi give me your ip now",
            "censorwords": "im sensitive",
            "embeds": "embed",
            "reducemotion": "less motion",
            "showpostbuttons": "always show post buttons",
            "underlinelinks": "always underline links",
            "magnify": "BIG TEXT",
            "entersend": "mobile newlines",
            "hideimages": "i dont want to see the images",
            "notifications": "HI CAN I ANNOY YOU",
            "widemode": "the better ui",
            "discord": "discord post layout (broken)",
            "compactmode": "make it smaller",
            "ulist": "userlist (enable this pls)",
        },
        "desc": {
            "homepage": "i hate the start page",
            "consolewarnings": "get the console warnings away from you",
            "blockedmessages": "vanquish the blocked users' messages",
            "invtyping": "people cant see you typing",
            "imagewhitelist": "see images from all websites",
            "censorwords": "censors your banned words",
            "embeds": "embeds, you probably know what this does",
            "reducemotion": "less moving, very cool",
            "showpostbuttons": "see post buttons so you have something to aim your mouse towards",
            "underlinelinks": "see links better among text",
            "magnify": "good for people with bad eyesight (needs refresh)",
            "entersend": "enter makes newlines instead of sending, good for mobile",
            "hideimages": "spoiler the images, good for if you're worried about another raid",
            "notifications": "give me notification",
            "widemode": "enables the better meo (needs refresh)",
            "discord": "reverses post order (kind of broken, needs refresh)",
            "compactmode": "be able to see more posts on your screen (needs refresh)",
            "ulist": "you can see who exactly's online",
        }
    },
    "account_sub": {
        "password": "Password",
        ...
        "devices": "devices",
        "added": "added auth app!",
        "recoverycode": "here's your recovery code, keep it safe:",
    },
    "appearance_sub": {
        "theme": "theme",
        "spthemes": "cool themes",
        "acthemes": "themes for bad eyesight",
        "ogthemes": "old themes",
        "glthemes": "glass themes",
        "cstheme": "your themes",
        "cscss": "css",
    ...
    "languages_sub": {
        "title": "pick a lang, any lang",
        "desc": "please make ",
        "link": "langs",
        "other": "the good langs"
    },
    "inbox_sub": {
        "desc": "announcements and stuff go here",
    },
    "live_sub": {
        "desc": "icognito mode if it was a meower chat"
    },
    "login_sub": {
        "title": "Login",
        "desc": "client by eris | eris.pages.dev",
        "oldpass": "old pswd",
        "newpass": "new pswd",
        "agreement": "tos and privacy policy",
    },
    "leave_sub": {
        "desc": "leaving already",
        "end": "????",
    },
    "action": {
        "logout": "log out",
        "login": "log in",
        "signup": "make new account (mistake)",
        "search": "look around",
        "mod": "do mod stuff",
        "creategc": "make gc",
        "leavegc": "leave gc?",
        "dmme": "dm eri",
        "invite": "inv someone (mistake)",
        "gohome": "go home",
        "cleartokens": "vanquish the tokens",
        "changepw": "your password leaked didnt it",
        "addtotp": "add auth app",
        "resetrecovery": "reset recovery code",
        "clearls": "reset localstorage",
        "deleteacc": "kill this account",
        "block": "block",
        "blockuser": "block user",
        "blockword": "ban word",
        "run": "run",
        ...
        "reply": "reply",
        "mention": "ping",
        "report": "mods, send him to the rubber room",
        "delete": "del taco",
        "edit": "can he fix it",
        "share": "share",
        "comment": "comment",
        ...
        "savetheme": "save",
        "loadtheme": "load",
        "resetplugins": "reset the plugins",
        "favorite": "favorite",
        "download": "download",
        "add": "add",
        "adduser": "add member (mistake)",
        "transfer": "transfer ownership (mistake)",
        "bug": "i found a bug",
        "datarequest": "give data",
        "discuss": "talk",
        "ping": "ping",
        "moddel": "mod delete",
        "modpost": "moderate post",
    ...
    "info": {
        "accexists": "sorry someone alr took that one",
        "invaliduser": "bad username",
        "invalidpass": "bad password",
        "invalidcreds": "bad username or password",
        "invalidotp": "no that isnt the code", // update
        "unknownmfa": "unknown mfa method! are you on the latest meo version?", // update
        "nopass": "enter your password you stupi", // update
        "nocode": "enter the mfa code", // update
        "authadd": "auth app added! here's your recovery code, keep it safe: ", // update
        "authrename": "auth renamed!",
        "authremove": "auth removed!",
        "accbanned": "you got smited by meower team",
        "accdeleted": "that account doesnt exist anymore",
        "conflict": "login conflict, close the other client and reload",
        "unknown": "error:",
        "chatremoved": "someone smited you from a gc",
        "passupdate": "password updated!",
        "editingpost": "editing:",
        "reportsent": "sent report!",
        "blockedip": "you cant use meower on this ip",
        "searchany": "look around",
        "cleartokens": "you know what this does, dont you",
        "clearls": "you're about to clear localstorage",
        "signup": "you agree to tos by signing up",
        "tokenscleared": "tokens cleared, please log in again",
        "accscheduled": "acc scheduled for deletion",
        "deletewarn": "it will be deleted forever!!!!",
        "changepwwarn": "it will be updated immediately!",
        "tryagain": "try again",
        "cleared": "cleared",
        "plugin": "restart now to apply",
        "replieslimit": "you reached the reply limit", // update
    },
    "reports": {
        "spam": "spam",
        "harassment": "very rude",
        "language": "racism/slurs",
        "nsfw": "nsfw",
        "scam": "scam/hack",
        "harm": "threatening to hurt someone else",
        "illegal": "illegal stuff",
        "suicide": "sh/suicide",
        "age": "underage user detected",
        "other": "other (please describe below)",
    },
    "modals": {
        "report": "report",
        "blockword": "ban a word",
        "blockauser": "block user (case sensitive)",
        "blockuser": "block",
        "unblockuser": "unblock",
        "bgimage": "background image link",
        "blockedip": "ip banned",
        "cleartokens": "clear tokens?",
        "changepass": "change pswd",
        "clearls": "clear localstorage?",
        "deleteacc": "delete acc?",
        "share": "share",
        "plugin": "refresh needed!",
        "shortcuts": "shortcuts",
        "copyuser": "copied username to clipboard!",
        "copygc": "copied link to gc!",
    },
    "profile": {
        "quote": "quote",
        "persona": "personalization",
    ...
    "chats": { // update
        ...
        "settings": "settings",
        "members": "members",
        "addmember": "add member (mistake)",
        "emojis": "emojis",
        "uploademoji": "upload emoji",
        "chatsettings": "gc settings",
        "leave": "leave",
        "update": "save gc",
    },
    "inputs": { // update
